...
export default function ProgressBar({ completed, total, percent }) {
  return (
    <section className="alx-card" aria-label="Overall progress">
      <div className="mb-3 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h2 className="text-sm font-bold uppercase tracking-wide">Curriculum Progress</h2>
      ...
      <div
        ...
        aria-valuemin={0}
        aria-valuemax={100}
        aria-label={`${percent}% of the curriculum complete`}
      >
        <div
